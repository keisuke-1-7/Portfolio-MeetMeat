...
class M_ProductsSeeder extends Seeder
{
   ...
   public function run()
   {
      DB::table('m_products')->insert([
         ...
         'product_image' => 'public/uploads/1sirloin.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
      ...
      DB::table('m_products')->insert([
         ...
         'product_image' => 'public/uploads/2rosu.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
         'resist_date' => date('Y-m-d H:i:s'),
         'user_id' => 1,
      ...
      DB::table('m_products')->insert([
         ...
         'product_image' => 'public/uploads/3hire.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
         'resist_date' => date('Y-m-d H:i:s'),
         'user_id' => 1,
      ...
      DB::table('m_products')->insert([
         ...
         'product_image' => 'public/uploads/4tan.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
         'resist_date' => date('Y-m-d H:i:s'),
         'user_id' => 2,
      ...
      DB::table('m_products')->insert([
         ...
         'product_image' => 'public/uploads/5tokusen.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
         'resist_date' => date('Y-m-d H:i:s'),
         'user_id' => 2,
      ...
      DB::table('m_products')->insert([
         ...
         'product_image' => 'public/uploads/6bara.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
         'resist_date' => date('Y-m-d H:i:s'),
         'user_id' => 2,
      ...
      DB::table('m_products')->insert([
         ...
         'price' => 8000,
         'description' => '最高品質の部位を集めた贅沢なセットです',
         'product_image' => 'public/uploads/7momo.jpg',
         'sale_status_id' => 1,
         'product_status_id' => 1,
         'resist_date' => date('Y-m-d H:i:s'),
         'user_id' => 2,
